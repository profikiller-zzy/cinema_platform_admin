<template>
  <div class="total-box">
    <span id="year-box">最近一周影院票房榜</span>
  </div>
  <div class="rank-title">
    <ul class="row">
      <li class="col0">排名</li>
      <li class="col1">电影院名</li>
  ...
  <div class="rank-list">
    <div v-for="(item, index) in data.rank_list" :key="index">
      <ul class="row">
        ...
        <li class="col1">
            <p class="first-line">{{ item.cinema_name }}</p>
        </li>
        <li class="col2">{{ item.revenue.toFixed(2) }}</li>
      </ul>
      <!-- 分界线 -->
...
import {cinemaRankApi} from "@/api/cinema_management.js";
